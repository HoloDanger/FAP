...
<div class="add-container">
  ...
  <form class="add-form" action="LoginServlet" method="POST">
    ...
    <p>Role:</p><input type="text" placeholder="Instructor/Student" name="role" required>
...
<div class="print-container">
  ...
  <form class="print-form" action="login.html" method="POST">
